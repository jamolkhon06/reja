...
class Shop {
    ...
    qoldiq() {
        return `At current hour: ${date}, there are ${this.bread}s bread, ${this.sausage}s sausages and ${this.butter}s butter available.`;
    }
    ...
    sotish(product, quantity) {
        if(product === "bread") {
            ...
            return 'There is no such kind of a product'
        }
        return `At ${date}, Sold items are: ${quantity} ${product}.`;
    }
    ...
    qabul(product, quantity) {
        ...
        return `At ${date}, Received items are: ${quantity} ${product}.`;
    }
}
